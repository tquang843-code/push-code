<?php
$title = 'Quản Lý Người Dùng'; // Tiêu đề trang
$baseUrl = '../'; // Đường dẫn cơ sở

require_once('../layouts/header.php'); // Nhúng tệp header

// Truy vấn lấy thông tin người dùng cùng với quyền của họ từ cơ sở dữ liệu
$sql = "select User.*, Role.name as role_name from User left join Role on User.role_id = Role.id where User.deleted = 0";
$data = executeResult($sql); // Thực hiện truy vấn và lấy kết quả
?>
