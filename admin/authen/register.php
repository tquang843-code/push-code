...
<head>
	<title>Đăng Ký</title>
	<meta charset="utf-8">
	<link rel="icon" type="image/png" href="https://cdn.iconscout.com/icon/premium/png-512-thumb/shoe-114-915576.png?f=webp&w=512" />

	<!-- CSS Bootstrap mới nhất đã biên dịch và nén -->
	...
	<!-- JavaScript Bootstrap mới nhất đã biên dịch -->
	<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
</head>

<body style="background-image: url(../../assets/photos/bgrdangky.jpeg); background-size: cover; background-repeat: no-repeat;">
	<div class="container">
